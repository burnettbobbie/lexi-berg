     ...
     <div class="carousel-container" style="margin-top:-10vh">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <iframe id="player-featured-2" class="yt-embed" width="100%" height="555"
                            src="https://www.youtube.com/embed/E4950fsFVxI?enablejsapi=1"
                            title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write;
                            encrypted-media; gyroscope; picture-in-picture" loading="" allowfullscreen></iframe>
                </div>

                <!-- Video 2 -->
                <div class="carousel-item">
                    <iframe id="player-featured" class="yt-embed" width="100%" height="555"
                            src="https://www.youtube.com/embed/KE-vpIM8440?enablejsapi=1"
                            title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write;
                            encrypted-media; gyroscope; picture-in-picture" loading="" allowfullscreen></iframe>
                </div>
                ...
                <!-- Video 3 -->
                <div class="carousel-item">
                    <iframe id="player-featured-3" class="yt-embed" width="100%" height="555"
                            src="https://www.youtube.com/embed/7k9EwpKw02Y?enablejsapi=1"
                            title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write;
                            encrypted-media; gyroscope; picture-in-picture" loading="" allowfullscreen></iframe>
                </div>
                ...
                <!-- Video 4 -->
                <div class="carousel-item">
                    <iframe id="player-featured-4" class="yt-embed" width="100%" height="555"
                            src="https://www.youtube.com/embed/GQPddFFxIPY?enablejsapi=1"
                            title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write;
                            encrypted-media; gyroscope; picture-in-picture" loading="" allowfullscreen></iframe>
                </div>
            </div>
...
.yt-embed {
    ...
    box-shadow: 0px 40px 20px 0px rgba(0, 0, 255, 0.16);
