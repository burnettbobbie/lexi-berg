...
<head>
	...
	<link href="https://db.onlinewebfonts.com/c/fb17e4fef5f63e0e89fec4fe89602648?family=BHF+Beats+Bold" rel="stylesheet">
...
<div id="scroll-container">
  <div id="scroll-text"><p>LONELY SATELLITE · NEW SINGLE OUT NOW!</p></div>
</div>
...
<iframe class="mobile-spotify" style="border-radius:20px;margin-top:-25vh;box-shadow: 0px 70px 50px -10px rgba(0, 0, 255, 0.16);border-bottom: 12px solid blue;" src="https://open.spotify.com/embed/artist/5ZN5AAuWmyLdheRP0rE7dK?utm_source=generator&theme=0" width="80%" height="552" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
...
<div class="wrap" >
	<div class="quote-slider">
		<div class="quote">
			<p><strong>"Unafraid to channel raw emotions."</strong><br>
			<span class="quote-source">Wonderland</span></p>
		</div>

		<div class="quote">
		<p><strong>"Lexi Berg provides us with euphoric escapism."</strong><br>
			<span class="quote-source">1883 Magazine</span></p>
		</div>
	...
	<!-- <a href="https://linktr.ee/LexiBergmusic" custom-link-name="Listen to the new single Lonely Satellite Link" target="_blank"><h2> Listen to &lsquo;Bermuda Triangle&rsquo; </h2></a> -->
	<br>
	<br>
