...
<head>
	...
	<link rel="stylesheet" href="https://use.typekit.net/sps5snk.css">
	<link rel="stylesheet" type="text/css" href="animsition/dist/css/animsition.min.css">
	<style media="screen">
		.bg-init,
...
<div class="header">
	...
	<div class="socials">
		...
		<a href="https://twitter.com/LexiBergMusic" target="_blank" data-track="twitter-ftr"><img src="img/social_twitter.png" alt="Twitter" class="socialicon"></a>
...
<div class="container">
        <!-- Header Section -->
        <h1 style="margin-top:-10vh">Press & Media</h1>

        <!-- Articles Grid -->
        <div class="grid">

            <!-- Article 1 -->
            <a href="https://indieboulevard.com/2024/07/14/cosmic-cure-for-city-blues-lexi-bergs-lonely-satellite-will-launch-you-out-of-anxiety/" target="_blank">
                <div class="article a1">
                    <h1 class="read-more"> Read More →</h1>
                </div>
            </a>

            <a href="https://www.itsallindie.com/2024/10/lexi-berg-unveils-her-big-new-single.html" target="_blank">
                <div class="article a1-2">
                    <h1 class="read-more">Read More →</h1>
                </div>
            </a>

            <a href="https://theindiegrid.co.uk/indie-pop/lonely-satellite-lexi-berg-an-emotive-return-to-form/" target="_blank">
                <div class="article a2">
                    <h1 class="read-more">Read More →</h1>
                </div>
            </a>

            <a href="https://cloutcloutclout.com/new-music/lexi-berg-lonely-satellite/" target="_blank">
                <div class="article a2-1">
                    <h1 class="read-more">Read More →</h1>
                </div>
            </a>

            <a href="https://www.lockmag.co.uk/lexi-berg-shines-on-heartfelt-intimate-new-single-bermuda-triangle/" target="_blank">
                <div class="article a2-2">
                    <h1 class="read-more">Read More →</h1>
                </div>
            </a>

            <a href="https://groovercity.com/lexi-berg-swedish-american-singer-london/" target="_blank">
                <div class="article a2-3">
                    <h1 class="read-more">Read More →</h1>
                </div>
            </a>

            <a href="https://1883magazine.com/lexi-berg-bermuda-triangle/" target="_blank">
                <div class="article a3">
                    <h1 class="read-more">Read More →</h1>
                </div>
            </a>

            <a href="https://www.revamp-magazine.co.uk/lexi-berg/" target="_blank">
                <div class="article a4">
                    <h1 class="read-more">Read More →</h1>
                </div>
            </a>

            <a href="https://www.thepunkhead.com/music/artist-spotlight-meet-lexi-berg" target="_blank">
            ...
            <a href="https://www.thelineofbestfit.com/features/interviews/lexi-berg-on-the-rise" target="_blank">
                <div class="article a6">
                    <h1 class="read-more">Read More →</h1>
                </div>
            </a>

            <a href="https://www.wonderlandmagazine.com/2021/05/14/new-noise-lexi-berg/" target="_blank">
                <div class="article a7">
                    <h1 class="read-more">Read More →</h1>
                </div>
            </a>
...
<footer>
	<span class="footer" style=""><a href="">Terms of Use</a> <a href="">Privacy Policy</a> <a href="" target="_blank">Cookies Policy</a> <h2>&copy; <?= date("Y") ?>LexiBerg</h2></span>
</footer>

<div class="mobile-nav">	
	<nav>
		<ul class="main">
			<li><a class="animsition-link" href="biography.php">Story</a></li>
			<li><a class="animsition-link" href="video.php">Video</a></li>
			<li><a class="animsition-link" href="live.php">Tour</a></li>
			<li><a class="animsition-link" href="press.php">Press</a></li>
            <li><a class="animsition-link ml-onclick-form" href="javascript:void(0)" onclick="ml('show', 'VHjK47', true)">Sign Up</a></li>
		</ul>
	</nav>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
      jQuery('.download-button').click(function (event) {
      ...
      jQuery('.signup-form').each(function () {
        var $formSignup = jQuery(this);
        var formWrapper;
        $formSignup.bind('submit', function (e) {
          e.preventDefault();
          formWrapper = jQuery(this).parents('.formarea');
          let $form = window.jQuery(this);
          ...
          console.log("default.js:da (55)", data);//fordebug: debug print
          jQuery.ajax({
            method: 'POST',
            url: 'https://signup.com/register?jsonp=cdcresult',
            data: data,
            cache: false
          }).always(function (err, r, s) {
            formWrapper.find('.form-wrapper').hide();
            formWrapper.find('.thankyou-wrapper').fadeIn();
